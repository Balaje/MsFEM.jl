...
"""
function multiscale_bases(aₕ::Function, V::FESpace, domain::SVector{2, T}, n::Int, N::Int, l::Int, p::Int; show_progress=true) where T<:Real
  ...
  @showprogress enabled=show_progress "Computing pLOD basis" for i=1:N
