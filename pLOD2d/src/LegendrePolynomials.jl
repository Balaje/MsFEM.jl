...
"""
function reference_rectangular_matrix(n::Int, N::Int, p::Int)
  a = ceil(Int, n/N);
...
"""
function assemble_rectangular_matrix(model_fine::CartesianDiscreteModel, n::Int, N::Int, p::Int)
  elem_fine = elements_in_coarse_scale_patch(get_cell_node_ids(model_fine), N, 0);  

  L₁, Z₁ = reference_rectangular_matrix(n, N, p)
...
"""
function assemble_legendre_mass_matrix(N::Int, p::Int)
